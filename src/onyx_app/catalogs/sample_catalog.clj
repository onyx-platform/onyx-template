(ns onyx-app.catalogs.sample-catalog)
...
(defn base-catalog [batch-size batch-timeout]
  [{:onyx/name :format-line
    :onyx/fn :onyx-app.functions.sample-functions/format-line
    :onyx/type :function
   ...
   {:onyx/name :upper-case
    :onyx/fn :onyx-app.functions.sample-functions/upper-case
    :onyx/type :function
    :onyx/batch-size batch-size
    :onyx/batch-timeout batch-timeout
...
(defmethod build-catalog :prod
  ...
  (into
    (base-catalog batch-size batch-timeout)
    [{:onyx/name :read-lines
      :onyx/plugin :onyx-app.plugins.http-reader/reader
      :onyx/type :input
      :onyx/medium :http
